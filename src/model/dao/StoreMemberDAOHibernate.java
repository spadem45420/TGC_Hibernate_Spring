...
//		dao.insert(bean2);
		// 修改
//		 StoreMember bean3 = new StoreMember();
////		 bean3.setStoreMemberId(3);
...
//		 dao.update(bean3);
		...
		// 查詢單筆 by storeUserName
		List<StoreMember> bean = dao.findByUsername("littleworld");
		for(StoreMember vo : bean){
